...
const zh: Texts = {
  ...
  home_lang_guide_title: "语言切换小提示",
  home_lang_guide_text: "右上角有“中文 / EN”按钮，点一下即可切换页面语言。",
  home_lang_guide_ok: "我知道了",
  home_start_nav: "✅ 开始导航",
...
const en: Texts = {
  ...
  home_lang_guide_title: "Language Switch Tip",
  home_lang_guide_text: "Use the \"中文 / EN\" button at the top right to switch app language.",
  home_lang_guide_ok: "Got it",
